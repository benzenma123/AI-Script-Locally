...
### Hints
- You can run this script (after run this script the first time for installation) without internet, just need the system had python already and plug in the power since it using cpu only mode and might comsum a lot of energy
